...
#define Direcao_Servo_PWM_Pin GPIO_PIN_2
#define Direcao_Servo_PWM_GPIO_Port GPIOC
#define Distancia_Servo_PWM_Pin GPIO_PIN_3
#define Distancia_Servo_PWM_GPIO_Port GPIOC
